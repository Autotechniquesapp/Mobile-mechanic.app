...
const detail={stripe:'Cards, hosted invoices, tax, Apple Pay / Google Pay where eligible.',square:'Cards, Square checkout links, invoices, Cash App Pay and wallets where eligible.'};
const visibleProviders=['stripe','square'];
...
async function connect(provider){if(busy||!visibleProviders.includes(provider))return;busy=true;try{
  let d;
