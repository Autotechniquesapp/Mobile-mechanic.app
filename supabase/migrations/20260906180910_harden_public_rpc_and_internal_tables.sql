revoke all on table public.integration_entity_mappings from anon, authenticated;
...
revoke all on table public.payment_processor_credentials from anon, authenticated;
revoke all on table public.plate_lookup_cache from anon, authenticated;
revoke all on table public.push_subscriptions from anon, authenticated;
revoke all on table public.push_vapid_config from anon, authenticated;
revoke all on table public.shop_integration_credentials from anon, authenticated;
